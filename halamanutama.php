...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
		<div class="container">
			<img src="assets/img/icon/1.png" style="width: 60px;"><a href="halamanutama.php" class="logo"><b>SINA<span>BUNG</span></b></a>
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item">
						<img src="assets/img/icon/logout.png" style="width: 20px;"><a class="nav-link" href="index.php" style="color: white; font-size: 20px; margin-left: 20px; margin-top: -35px;">Login</a>
					</li>
				</ul>
			</div>
		</div>
